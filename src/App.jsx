    ...
    <header id="home" className="hero-new-banner banner">
      ...
      <div className="gp-content">
        <div className="gp-logo-area">
          <div className="gp-logo-g-image-wrapper">
            <img src={currentLogo} alt="Graphicsporium" className="gp-logo-base-img" />
            <div className="gp-logo-color-overlay" style={{ WebkitMaskImage: `url(${currentLogo})`, maskImage: `url(${currentLogo})` }}></div>
          </div>
          <div className="gp-wordmark">Creative &nbsp;&middot;&nbsp; Design &nbsp;&middot;&nbsp; Branding</div>
        </div>
