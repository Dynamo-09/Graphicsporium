...
const PortfolioPage = ({ isDarkTheme, toggleTheme, currentLogo, currentMsmeLogo, onWhatsAppClick }) => {
  ...
  const handleAddToCart = (item) => {
    // Dummy handler for the ServiceModal if rendered
  };
  ...
  return (
    <div style={pageStyle}>
      ...
      <main style={{ paddingTop: '120px', paddingBottom: '4rem', position: 'relative' }}>
        <button 
          onClick={() => navigate('/')} 
          style={{
            position: 'absolute',
