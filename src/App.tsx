...
// --- Navigation ---
export const Navbar = ({ isDarkTheme, toggleTheme, currentLogo, onNavClick, onToggleConsultation }) => {
    ...
    <>
      ...
      <div className="app">
        ...
        <Routes>
          ...
          <Route path="/services" element={<ServicesPage isDarkTheme={isDarkTheme} toggleTheme={() => setIsDarkTheme(!isDarkTheme)} currentLogo={currentLogo} currentMsmeLogo={currentMsmeLogo} onWhatsAppClick={handleWhatsAppRedirect} onAddToCart={handleAddToCart} />} />
          <Route path="/portfolio" element={<PortfolioPage isDarkTheme={isDarkTheme} toggleTheme={() => setIsDarkTheme(!isDarkTheme)} currentLogo={currentLogo} currentMsmeLogo={currentMsmeLogo} onWhatsAppClick={handleWhatsAppRedirect} onAddToCart={handleAddToCart} />} />
