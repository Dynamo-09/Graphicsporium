...
const ServicesPage = ({ isDarkTheme, toggleTheme, currentLogo, currentMsmeLogo, onWhatsAppClick, onAddToCart, cartItemCount }) => {
  ...
  return (
    <div style={pageStyle}>
      ...
      <main style={{ paddingTop: '100px', paddingBottom: '4rem', flexGrow: 1 }}>
